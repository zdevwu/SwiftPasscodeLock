...
class EnterPasscodeStateTests: XCTestCase {
    ...
    override func setUp() {
        ...
        passcodeState = EnterPasscodeState(stringsToShow: nil, tintColor: nil, font: nil)
    ...
    func testIncorrectPasscodeNotification() {
        ...
        passcodeState.acceptPasscode(["0"], fromLock: passcodeLock, stringsToShow: nil, tintColor: nil, font: nil)
        passcodeState.acceptPasscode(["0"], fromLock: passcodeLock, stringsToShow: nil, tintColor: nil, font: nil)
        passcodeState.acceptPasscode(["0"], fromLock: passcodeLock, stringsToShow: nil, tintColor: nil, font: nil)
